...
class App(ui_slint):
    def __init__(self):
        ...
        self.handle_script_module_click = (
            self.support_page_controller.on_script_module_click
        )  # Conecta o callback de clique do script ao controlador
        self.navigate_to = (
            self.modules_list_controller.on_navigate_to
        )  # Conecta o callback de navegação ao controlador

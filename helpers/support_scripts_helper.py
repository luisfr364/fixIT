...
class SupportScriptsHelper:
    ...
    # TODO: Check if there's no danger of erasing important files
    async def run_clean_temp_files_script(self, cb):
        ...
        try:
            ...
            cb(
                f"Foram encontrados {len(files)} arquivos temporários. Iniciando limpeza..."
            )
        ...
        commands = [
            {
                ...
                "description": "Liberando endereço IP...\n",
            },

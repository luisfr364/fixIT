...
class SupportPageController:
    ...
    def on_script_module_click(self, name, description):
        ...
        self.app.selected_script = {"name": name, 
    ...
    async def on_run_script(self):
        ...
        selected_script = self.app.selected_script # Gets the selected_script var value from the main window


        match selected_script.name: # Decide which script to run based on the selected script
